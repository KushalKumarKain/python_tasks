  ...
  def run(overallUnits):
    if toc == 1:
      ...
      if a==1:
        ...
        print("For this option, the rate is set to be 225/KW, so your bill comes to be Rs",result)
      elif a==2:
        result = (overallUnits*285)
        print("For this option, the rate is set to be 285/KW, so your bill comes to be Rs",result)
      else:
        raise NumberError
