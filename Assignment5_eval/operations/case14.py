class Fourteen():
  def run():
    ...
    if toc==1:
      ...
      print("There is only Flat Phase available in this case adn its rate is 355 Paisa/unit so your bill comes out to be Rs", result)
      
    elif toc==2:
      overallUnits = int(input("Enter the amount of kWs used: "))
      a = int(input("Is it 1. For Billing demand up to and including contract demand OR 2. For Billing demand in excess of contract demand"))
      if a==1:
        result = (overallUnits*335)
        print("For this option, the rate is set to be 335/KW/month, so your bill comes to be Rs",result)
      elif a==2:
        result = (overallUnits*385)
        print("For this option, the rate is set to be 385/KW/month, so your bill comes to be Rs",result)
