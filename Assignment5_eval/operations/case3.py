    ...
    def run():
      ...
      """
        ...
        if toc == 1:
            ...
            kwUsage = int(
                input("Enter the amount of KW power used (must be between 1 to 15): ")
            )

            if top == 3:
                result = kwUsage * 70
                print(
                    "Rates for Single Phase is 70Rs/month/KW, hence your bill comes out to be  Rs",
                    result,
                )
                ...
                result = kwUsage * 90
                print(
                    "Rates for Single Phase is 90Rs/month/KW, hence your bill comes out to be  Rs",
                    result,
                )
